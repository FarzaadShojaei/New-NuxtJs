...
<div style="display:flex">
    <img v-for="image in home.images" :key="image" :src="image" width="200" height="150" alt="something descriptive..."/>
...
export default {
    ...
    created(){
       const home=homes.find((home)=>home.objectID == this.$route.param.id)
       this.home=home;
    }
}
</script>